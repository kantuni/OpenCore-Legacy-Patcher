...
**DELTA**   | Often used with OTA, refers to OS updates that are much smaller than full installers (generally ~3GB). Note: DELTAs require the root volume to be unmodified otherwise ~12GB updates will occur.
---
Term | Description
--- | ---
